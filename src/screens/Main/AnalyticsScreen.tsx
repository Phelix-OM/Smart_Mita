              ...
              <View style={styles.statsContainer}>
                <View style={styles.statItem}>
                  <Text style={[styles.statValue, { color: colors.primary, fontSize: scaledFontSize(20) }]}>
                    {selectedTimeRange === "day" ? "28.4" : 
                     selectedTimeRange === "week" ? "175.4" : 
                     selectedTimeRange === "month" ? "717.0" : "6,650"}
                    <Text style={[styles.statUnit, { color: colors.textSecondary, fontSize: scaledFontSize(14) }]}> kWh</Text>
                  </Text>
                ...
                <View style={styles.statItem}>
                  <Text style={[styles.statValue, { color: colors.success, fontSize: scaledFontSize(20) }]}>
                    -5.2%
                  </Text>
                  <Text style={[styles.statLabel, { color: colors.textSecondary, fontSize: scaledFontSize(14) }]}>
                    vs Previous
                ...
                <View style={styles.statItem}>
                  <Text style={[styles.statValue, { color: colors.primary, fontSize: scaledFontSize(20) }]}>
                    {selectedTimeRange === "day" ? "4.7" : 
                     selectedTimeRange === "week" ? "25.1" : 
                     selectedTimeRange === "month" ? "179.3" : "554.2"}
                    <Text style={[styles.statUnit, { color: colors.textSecondary, fontSize: scaledFontSize(14) }]}> kWh</Text>
                  </Text>
                  <Text style={[styles.statLabel, { color: colors.textSecondary, fontSize: scaledFontSize(14) }]}>
                    Average
            ...
            <View style={[styles.card, { backgroundColor: colors.card }]}>
              ...
              <View style={styles.scoreContainer}>
                <View style={[styles.scoreCircle, { borderColor: colors.primary }]}>
                  <Text style={[styles.scoreValue, { color: colors.primary, fontSize: scaledFontSize(32) }]}>
                    85
                  </Text>
              ...
              <BarChart
                ...
                chartConfig={{
                  ...
                  color: (opacity = 1, index = 0) => {
                    ...
                    return barColors[index] || barColors[0];
                  },
                }}
                style={styles.chart}
                yAxisSuffix=" kWh"
              ...
              <View style={styles.historicalComparison}>
                <View style={styles.comparisonItem}>
                  ...
                  <Text style={[styles.comparisonValue, { color: colors.text, fontSize: scaledFontSize(16) }]}>
                    {selectedTimeRange === "day" ? "28.4" : 
                     selectedTimeRange === "week" ? "175.4" : 
                     selectedTimeRange === "month" ? "717.0" : "6,650"} kWh
                  </Text>
                </View>
                ...
                <View style={styles.comparisonItem}>
                  ...
                  <Text style={[styles.comparisonValue, { color: colors.text, fontSize: scaledFontSize(16) }]}>
                    {selectedTimeRange === "day" ? "30.1" : 
                     selectedTimeRange === "week" ? "185.2" : 
                     selectedTimeRange === "month" ? "756.3" : "7,012"} kWh
                  </Text>
                </View>
                ...
                <View style={styles.comparisonItem}>
                  ...
                  <Text style={[styles.comparisonValue, { color: colors.success, fontSize: scaledFontSize(16) }]}>
                    -5.2% (Saved {selectedTimeRange === "day" ? "1.7" : 
                     selectedTimeRange === "week" ? "9.8" : 
                     selectedTimeRange === "month" ? "39.3" : "362"} kWh)
                  </Text>
                </View>
              </View>
            </View>
                ...
                {deviceUsage.map((device) => (
                  <View key={device.id} style={styles.deviceItem}>
                    <View style={styles.deviceInfo}>
                      <Ionicons 
                        name={
                          device.category === "cooling" ? "snow-outline" :
                          device.category === "heating" ? "water-outline" :
                          device.category === "appliance" ? "thermometer-outline" :
                          device.category === "lighting" ? "bulb-outline" : "apps-outline"
                        } 
                        size={20} 
                        color={colors.primary} 
                    ...
                    <View style={styles.deviceStats}>
                      ...
                      <Text style={[styles.devicePercentage, { color: colors.textSecondary, fontSize: scaledFontSize(14) }]}>
                        ({device.percentage}%)
                      </Text>
                    </View>
                  </View>
              ...
              <View style={styles.recommendationList}>
                <View style={styles.recommendationItem}>
                  ...
                  <View style={styles.recommendationContent}>
                    ...
                    <Text style={[styles.recommendationText, { color: colors.textSecondary, fontSize: scaledFontSize(14) }]}>
          ...
          <View style={styles.section}>
            <View style={[styles.card, { backgroundColor: colors.card }]}>
              ...
              <BarChart
                    data={{
                    labels: ["Jan", "Feb", "Mar"],
                    datasets: [{ data: [10, 20, 30], color: () => "#FF0000" }]
                         }}
                     width={300}
                     height={200}
              ...
              <View style={styles.costSummary}>
                <View style={styles.costItem}>
                  ...
                  <Text style={[styles.costValue, { color: colors.text, fontSize: scaledFontSize(18) }]}>
                    {selectedTimeRange === "day" ? "1,698" : 
                     selectedTimeRange === "week" ? "10,524" : 
                     selectedTimeRange === "month" ? "43,020" : "399,000"} KES
                  </Text>
                </View>
                ...
                <View style={styles.costItem}>
                  ...
                  <Text style={[styles.costValue, { color: colors.text, fontSize: scaledFontSize(18) }]}>
                    {selectedTimeRange === "day" ? "283" : 
                     selectedTimeRange === "week" ? "1,504" : 
                     selectedTimeRange === "month" ? "10,755" : "33,250"} KES
                  </Text>
                </View>
                ...
                <View style={styles.costItem}>
                  ...
                  <Text style={[styles.costValue, { color: colors.success, fontSize: scaledFontSize(18) }]}>
                    {selectedTimeRange === "day" ? "170" : 
                     selectedTimeRange === "week" ? "1,052" : 
                     selectedTimeRange === "month" ? "4,302" : "39,900"} KES
                  </Text>
                </View>
              </View>
            </View>
