...
export default function InsightsScreen() {
  ...
  type DeviceIcon = "snow-outline" | "water-outline" | "thermometer-outline" | "bulb-outline" | "apps-outline";
  
  const devices: { id: string; name: string; usage: number; icon: DeviceIcon }[] = [
  ...
  type RecommendationIcon = "snow-outline" | "water-outline" | "thermometer-outline" | "bulb-outline" | "power-outline";
  
  const recommendations: { id: string; title: string; description: string; savings: number; icon: RecommendationIcon }[] = [
    {
      id: "1",
